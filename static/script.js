			...
			function updateData(){
				...
				g_line.selectAll("path").remove()
			  	...
			  	d3.json(request, function(data) {
					...
					var lines = g_line.selectAll(".lineConnect").data(data.polylines);
					...
					function update() {
					    ...
					    circles
					    	.attr("cx", function(d) { return projectPoint(d.geometry.coordinates[1], d.geometry.coordinates[0]).x; })
					    	.attr("cy", function(d) { return projectPoint(d.geometry.coordinates[1], d.geometry.coordinates[0]).y; })
								;
